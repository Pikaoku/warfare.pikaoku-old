...
import {
  ...
  updateSavedAspects,
  updateUserAspects
} from "./features/aspects/store/aspectsActions";
import { armiesActions } from "./features/battle/initiative/store/armiesReducer";
...
import {
  ...
  updateSavedFeatures,
  updateUserFeatures
} from "./features/features/store/featuresActions";
import Rules from "./features/rules/pages/Rules";
import UnitMaker from "./features/unitmaker/pages/UnitMaker";
import WarfareInitiative from "./features/battle/initiative/pages/WarfareInitiative";
import {
  updateSavedUnits,
  updateUserUnits
} from "./features/units/store/unitsActions";
import {
  coreAspects$,
  coreFeatures$,
  login$,
...
class App extends Component {
  componentWillMount() {
    ...
    userArmies$.subscribe(updateUserArmies);
  }
      ...
      <div>
        ...
        <BrowserRouter>
          ...
          <Switch>
            ...
            <Route exact path={"/initiative"} component={WarfareInitiative} />
...
export default connect(
  null,
  {
    ...
    onSignOut,
    updateCoreAspects,
    updateUserArmies: armiesActions.updateUserArmies,
    updateUserAspects,
    updateSavedAspects,
    updateCoreFeatures,
    updateUserFeatures,
